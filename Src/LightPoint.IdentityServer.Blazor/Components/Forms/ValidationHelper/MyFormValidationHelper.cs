...
{
    internal static class MyFormValidationHelper
    {
        ...
        private static bool MinIsValid(FormValidationContext validationContext, out ValidationResult? result)
        {
            ...
            if (rule.Min != null)
            {
                ...
                {
                    attribute = new MyNumberMinAttribute((decimal)rule.Min);
        ...
        private static bool MaxIsValid(FormValidationContext validationContext, out ValidationResult? result)
        {
            ...
            if (rule.Max != null)
            {
                ...
                if (rule.Type.IsIn(FormFieldType.Number, FormFieldType.Integer, FormFieldType.Float))
                {
                    attribute = new MyNumberMaxAttribute((decimal)rule.Max);
        ...
        private static bool TypeIsValid(FormValidationContext validationContext, out ValidationResult? result)
        {
            ...
            var attribute = new MyTypeAttribute(rule.Type);
        ...
        private static bool OneOfIsValid(FormValidationContext validationContext, out ValidationResult? result)
        {
            ...
            {
                var attribute = new MyOneOfAttribute(rule.OneOf);
        ...
        public static string GetTypeMessage(this FormValidateErrorMessages formValidateErrorMessages, FormFieldType type)
        {
            return type switch
            {
                FormFieldType.String => formValidateErrorMessages.Types.String,
                FormFieldType.Number => formValidateErrorMessages.Types.Number,
                FormFieldType.Boolean => formValidateErrorMessages.Types.Boolean,
                FormFieldType.Regexp => formValidateErrorMessages.Types.Regexp,
                FormFieldType.Integer => formValidateErrorMessages.Types.Integer,
                FormFieldType.Float => formValidateErrorMessages.Types.Float,
                FormFieldType.Array => formValidateErrorMessages.Types.Array,
                FormFieldType.Object => formValidateErrorMessages.Types.Object,
                FormFieldType.Enum => formValidateErrorMessages.Types.Enum,
                FormFieldType.Date => formValidateErrorMessages.Types.Date,
                FormFieldType.Url => formValidateErrorMessages.Types.Url,
                FormFieldType.Email => formValidateErrorMessages.Types.Email,
                _ => "",
            };
        }
    }
