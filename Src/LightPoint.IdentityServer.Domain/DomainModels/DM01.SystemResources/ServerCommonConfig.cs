...
{
    public class ServerCommonConfig : DomainModelBase<Guid>
    {
        /// <summary>
        /// 登出后自动回调
        /// </summary>
        ...
        /// 允许使用邮箱验证码重置密码
        /// </summary>
        public bool EnableResetPasswordByEmail { get; set; }
        /// <summary>
        /// 允许使用手机验证码重置密码
        /// </summary>
        ...
        /// </summary>
        public bool AllowRemenberme { get; set; }
        /// <summary>
        /// 启用人机校验功能
        /// </summary>
        public bool EnableHumanMachineVerification { get; set; }
        /// <summary>
        /// 人机校验类型
        /// </summary>
        public HumanMachineVerificationType HumanMachineVerificationType { get; set; }
